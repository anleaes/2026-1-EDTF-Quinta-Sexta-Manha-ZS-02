...
export default function Settings({ onCancel, refreshData, onLogout }) {
    ...
    <div className="scrollable-y" style={{ width: '100%', padding: '20px' }}>
      ...
      <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <button 
          ...
          onClick={onLogout}
          className="btn-secondary"
          style={{ width: '100%', borderColor: 'rgba(239, 68, 68, 0.25)', color: '#EF4444' }}
        >
        ...
        {forceDemo && (
          <button 
            ...
            className="btn-secondary"
            style={{ width: '100%', borderColor: 'rgba(239, 68, 68, 0.25)', color: 'var(--crimson)', marginTop: '0px' }}
          >
